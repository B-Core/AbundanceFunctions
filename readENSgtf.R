...
readENSgtf = function (filename, gtf.colnames=c('seqname','source','feature','start','end','score','strand','frame','attribute'), feature.col=9, comma.sub="|", curly.open.sub='<',curly.end.sub='>',comment.char='#'){
  # arguments
